...
public sealed class DurationCeilingTests
{
    ...
    public void A_45_minute_Window_admits_the_30_bucket_and_below_and_not_60()
    {
        ...
        var ceiling = DurationCeiling.WindowCeiling(length);
    ...
    public void A_Windows_ceiling_is_derived_from_its_length_and_cannot_be_authored()
    {
        ...
        var ceiling = window.DurationCeiling(Date, Resolution);
    ...
    {
        var bucket = DurationCeiling.SnapUp(60);
    ...
    {
        var bucket = DurationCeiling.SnapUp(45);
    ...
    {
        var bucket = DurationCeiling.SnapUp(61);
